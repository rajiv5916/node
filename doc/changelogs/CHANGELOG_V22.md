...
* \[[`ec3f9f060d`](https://github.com/nodejs/node/commit/ec3f9f060d)] - **assert**: improve partialDeepStrictEqual performance (Ruben Bridgewater) [#57509](https://github.com/nodejs/node/pull/57509)
* \[[`3c88f3938b`](https://github.com/nodejs/node/commit/3c88f3938b)] - **(SEMVER-MINOR)** **assert**: implement partial error comparison (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`db19a3f9fc`](https://github.com/nodejs/node/commit/db19a3f9fc)] - **(SEMVER-MINOR)** **assert**: improve partialDeepStrictEqual (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`e099717aa9`](https://github.com/nodejs/node/commit/e099717aa9)] - **assert**: improve myers diff performance (Giovanni Bucci) [#57279](https://github.com/nodejs/node/pull/57279)
* \[[`b0c162dbe3`](https://github.com/nodejs/node/commit/b0c162dbe3)] - **(SEMVER-MINOR)** **assert,util**: improve performance (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`159b9cf79b`](https://github.com/nodejs/node/commit/159b9cf79b)] - **(SEMVER-MINOR)** **benchmark**: adjust assert runtimes (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`073b15d52d`](https://github.com/nodejs/node/commit/073b15d52d)] - **(SEMVER-MINOR)** **benchmark**: skip running some assert benchmarks by default (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`1922cb1042`](https://github.com/nodejs/node/commit/1922cb1042)] - **(SEMVER-MINOR)** **benchmark**: add assert partialDeepStrictEqual benchmark (Ruben Bridgewater) [#57370](https://github.com/nodejs/node/pull/57370)
* \[[`86924aa533`](https://github.com/nodejs/node/commit/86924aa533)] - **benchmark**: add a warmup on bench-openSync (Elves Vieira) [#57051](https://github.com/nodejs/node/pull/57051)
* \[[`089bc0bd1f`](https://github.com/nodejs/node/commit/089bc0bd1f)] - **build**: fix update-wpt workflow (Jonas) [#57468](https://github.com/nodejs/node/pull/57468)
* \[[`5fa21c7fc4`](https://github.com/nodejs/node/commit/5fa21c7fc4)] - **build**: fix compatibility with V8's `depot_tools` (Richard Lau) [#57330](https://github.com/nodejs/node/pull/57330)
* \[[`d857ae06c5`](https://github.com/nodejs/node/commit/d857ae06c5)] - **build**: print 'Formatting Markdown...' for long task markdown formatting (1ilsang) [#57108](https://github.com/nodejs/node/pull/57108)
* \[[`e1aba366f3`](https://github.com/nodejs/node/commit/e1aba366f3)] - **build**: fix GN build failure (Cheng) [#57013](https://github.com/nodejs/node/pull/57013)
* \[[`043d304068`](https://github.com/nodejs/node/commit/043d304068)] - **build**: fix GN build of uv (Cheng) [#56955](https://github.com/nodejs/node/pull/56955)
...
* \[[`3e34e21bfe`](https://github.com/nodejs/node/commit/3e34e21bfe)] - **build,win**: disable node pch with ccache (Stefan Stojanovic) [#57224](https://github.com/nodejs/node/pull/57224)
...
* \[[`f447d0e854`](https://github.com/nodejs/node/commit/f447d0e854)] - **cli**: clarify --cpu-prof-name allowed values (Eugenio Ceschia) [#57433](https://github.com/nodejs/node/pull/57433)
* \[[`1ee5f840b4`](https://github.com/nodejs/node/commit/1ee5f840b4)] - **(SEMVER-MINOR)** **cli**: allow --cpu-prof\* in NODE\_OPTIONS (Carlos Espa) [#57018](https://github.com/nodejs/node/pull/57018)
* \[[`f277c96538`](https://github.com/nodejs/node/commit/f277c96538)] - **crypto**: ensure expected JWK alg in SubtleCrypto.importKey RSA imports (Filip Skokan) [#57450](https://github.com/nodejs/node/pull/57450)
* \[[`872ee0f2ac`](https://github.com/nodejs/node/commit/872ee0f2ac)] - **crypto**: update root certificates to NSS 3.108 (Node.js GitHub Bot) [#57381](https://github.com/nodejs/node/pull/57381)
* \[[`5f396ac26b`](https://github.com/nodejs/node/commit/5f396ac26b)] - **crypto**: add support for intermediate certs in --use-system-ca (Tim Jacomb) [#57164](https://github.com/nodejs/node/pull/57164)
* \[[`71c861171a`](https://github.com/nodejs/node/commit/71c861171a)] - **crypto**: support --use-system-ca on non-Windows and non-macOS (Joyee Cheung) [#57009](https://github.com/nodejs/node/pull/57009)
* \[[`525cee8bc8`](https://github.com/nodejs/node/commit/525cee8bc8)] - **crypto**: fix missing OPENSSL\_NO\_ENGINE guard (Shelley Vohr) [#57012](https://github.com/nodejs/node/pull/57012)
* \[[`524eb0ee5a`](https://github.com/nodejs/node/commit/524eb0ee5a)] - **crypto**: cleanup root certificates and skip PEM deserialization (Joyee Cheung) [#56999](https://github.com/nodejs/node/pull/56999)
* \[[`03a0f3a56b`](https://github.com/nodejs/node/commit/03a0f3a56b)] - **(SEMVER-MINOR)** **crypto**: support --use-system-ca on Windows (Joyee Cheung) [#56833](https://github.com/nodejs/node/pull/56833)
...
* \[[`94647bbdb2`](https://github.com/nodejs/node/commit/94647bbdb2)] - **(SEMVER-MINOR)** **crypto**: added support for reading certificates from macOS system store (Tim Jacomb) [#56599](https://github.com/nodejs/node/pull/56599)
* \[[`4479560818`](https://github.com/nodejs/node/commit/4479560818)] - **debugger**: fix behavior of plain object exec in debugger repl (Dario Piotrowicz) [#57498](https://github.com/nodejs/node/pull/57498)
* \[[`3d5fc7d6dc`](https://github.com/nodejs/node/commit/3d5fc7d6dc)] - **deps**: update c-ares to v1.34.5 (Node.js GitHub Bot) [#57792](https://github.com/nodejs/node/pull/57792)
* \[[`96b1edef06`](https://github.com/nodejs/node/commit/96b1edef06)] - **deps**: update undici to 6.21.2 (Matteo Collina) [#57442](https://github.com/nodejs/node/pull/57442)
* \[[`9bd09d4061`](https://github.com/nodejs/node/commit/9bd09d4061)] - **deps**: V8: cherry-pick c172ffc5bf54 (Choongwoo Han) [#57437](https://github.com/nodejs/node/pull/57437)
* \[[`bd474d744c`](https://github.com/nodejs/node/commit/bd474d744c)] - **deps**: update googletest to 0bdccf4 (Node.js GitHub Bot) [#57380](https://github.com/nodejs/node/pull/57380)
* \[[`c20c70035f`](https://github.com/nodejs/node/commit/c20c70035f)] - **deps**: update acorn to 8.14.1 (Node.js GitHub Bot) [#57382](https://github.com/nodejs/node/pull/57382)
* \[[`8956671b89`](https://github.com/nodejs/node/commit/8956671b89)] - **deps**: update amaro to 0.4.1 (marco-ippolito) [#57121](https://github.com/nodejs/node/pull/57121)
* \[[`1795255b34`](https://github.com/nodejs/node/commit/1795255b34)] - **deps**: update amaro to 0.3.2 (marco-ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`6d4d5f8c7e`](https://github.com/nodejs/node/commit/6d4d5f8c7e)] - **deps**: update amaro to 0.3.1 (Node.js GitHub Bot) [#56785](https://github.com/nodejs/node/pull/56785)
* \[[`aa3ac77fe9`](https://github.com/nodejs/node/commit/aa3ac77fe9)] - **deps**: update simdjson to 3.12.2 (Node.js GitHub Bot) [#57084](https://github.com/nodejs/node/pull/57084)
* \[[`53fba79f47`](https://github.com/nodejs/node/commit/53fba79f47)] - **deps**: update archs files for openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`7efef4c326`](https://github.com/nodejs/node/commit/7efef4c326)] - **deps**: upgrade openssl sources to quictls/openssl-3.0.16 (Node.js GitHub Bot) [#57335](https://github.com/nodejs/node/pull/57335)
* \[[`f279beb8b2`](https://github.com/nodejs/node/commit/f279beb8b2)] - **deps**: update corepack to 0.32.0 (Node.js GitHub Bot) [#57265](https://github.com/nodejs/node/pull/57265)
* \[[`994c997c58`](https://github.com/nodejs/node/commit/994c997c58)] - **deps**: update gyp file for ngtcp2 1.11.0 (Richard Lau) [#57225](https://github.com/nodejs/node/pull/57225)
* \[[`a93662f4a1`](https://github.com/nodejs/node/commit/a93662f4a1)] - **deps**: update cjs-module-lexer to 2.1.0 (Node.js GitHub Bot) [#57180](https://github.com/nodejs/node/pull/57180)
* \[[`f1620ec920`](https://github.com/nodejs/node/commit/f1620ec920)] - **deps**: update ngtcp2 to 1.11.0 (Node.js GitHub Bot) [#57179](https://github.com/nodejs/node/pull/57179)
* \[[`81fa6e2448`](https://github.com/nodejs/node/commit/81fa6e2448)] - **deps**: update sqlite to 3.49.1 (Node.js GitHub Bot) [#57178](https://github.com/nodejs/node/pull/57178)
...
* \[[`f9f611fb58`](https://github.com/nodejs/node/commit/f9f611fb58)] - **(SEMVER-MINOR)** **deps,tools**: add zstd 1.5.6 (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)
* \[[`fa10ba06e0`](https://github.com/nodejs/node/commit/fa10ba06e0)] - **dns**: restore dns query cache ttl (Ethan Arrowood) [#57640](https://github.com/nodejs/node/pull/57640)
* \[[`243aea4bd6`](https://github.com/nodejs/node/commit/243aea4bd6)] - **dns**: remove redundant code using common variable (Deokjin Kim) [#57386](https://github.com/nodejs/node/pull/57386)
* \[[`07a6d5f8cf`](https://github.com/nodejs/node/commit/07a6d5f8cf)] - **(SEMVER-MINOR)** **dns**: add TLSA record query and parsing (Rithvik Vibhu) [#52983](https://github.com/nodejs/node/pull/52983)
* \[[`98c4c602cc`](https://github.com/nodejs/node/commit/98c4c602cc)] - **doc**: add gurgunday as triager (Gürgün Dayıoğlu) [#57594](https://github.com/nodejs/node/pull/57594)
* \[[`3b7551e91d`](https://github.com/nodejs/node/commit/3b7551e91d)] - **doc**: clarify behaviour of node-api adjust function (Michael Dawson) [#57463](https://github.com/nodejs/node/pull/57463)
* \[[`3540bac72f`](https://github.com/nodejs/node/commit/3540bac72f)] - **doc**: remove Corepack documentation (Antoine du Hamel) [#57635](https://github.com/nodejs/node/pull/57635)
* \[[`4fb2352442`](https://github.com/nodejs/node/commit/4fb2352442)] - **doc**: remove mention of `--require` not supporting ES modules (Huáng Jùnliàng) [#57620](https://github.com/nodejs/node/pull/57620)
* \[[`8b84963e5e`](https://github.com/nodejs/node/commit/8b84963e5e)] - **doc**: mention reports should align with Node.js CoC (Rafael Gonzaga) [#57607](https://github.com/nodejs/node/pull/57607)
* \[[`868b490c09`](https://github.com/nodejs/node/commit/868b490c09)] - **doc**: add section stating that very stale PRs should be closed (Dario Piotrowicz) [#57541](https://github.com/nodejs/node/pull/57541)
* \[[`59033a1dc3`](https://github.com/nodejs/node/commit/59033a1dc3)] - **doc**: add bjohansebas as triager (Sebastian Beltran) [#57564](https://github.com/nodejs/node/pull/57564)
* \[[`53dcaa21b4`](https://github.com/nodejs/node/commit/53dcaa21b4)] - **doc**: update support channels (Claudio W.) [#57538](https://github.com/nodejs/node/pull/57538)
* \[[`b04b245722`](https://github.com/nodejs/node/commit/b04b245722)] - **doc**: remove cryptoStream API reference (Jonas) [#57579](https://github.com/nodejs/node/pull/57579)
* \[[`92eeee3e8d`](https://github.com/nodejs/node/commit/92eeee3e8d)] - **doc**: module resolution pseudocode corrections (Marcel Laverdet) [#57080](https://github.com/nodejs/node/pull/57080)
* \[[`1362873a8d`](https://github.com/nodejs/node/commit/1362873a8d)] - **doc**: add history entry for DEP0190 in `child_process.md` (Antoine du Hamel) [#57544](https://github.com/nodejs/node/pull/57544)
* \[[`2c696f6bae`](https://github.com/nodejs/node/commit/2c696f6bae)] - **doc**: remove deprecated pattern in `child_process.md` (Antoine du Hamel) [#57568](https://github.com/nodejs/node/pull/57568)
* \[[`12c2dfc5e3`](https://github.com/nodejs/node/commit/12c2dfc5e3)] - **doc**: mark multiple experimental APIS as stable (James M Snell) [#57510](https://github.com/nodejs/node/pull/57510)
* \[[`7e70f389ab`](https://github.com/nodejs/node/commit/7e70f389ab)] - **doc**: remove mertcanaltin from Triagers (Mert Can Altin) [#57531](https://github.com/nodejs/node/pull/57531)
* \[[`3ab90453da`](https://github.com/nodejs/node/commit/3ab90453da)] - **doc**: recommend watching the collaborators repo in the onboarding doc (Darshan Sen) [#57527](https://github.com/nodejs/node/pull/57527)
* \[[`3d5c4604ca`](https://github.com/nodejs/node/commit/3d5c4604ca)] - **doc**: remove mention of visa fees from onboarding doc (Darshan Sen) [#57526](https://github.com/nodejs/node/pull/57526)
* \[[`d1367420a2`](https://github.com/nodejs/node/commit/d1367420a2)] - **doc**: deprecate passing `args` to `spawn` and `execFile` (Antoine du Hamel) [#57389](https://github.com/nodejs/node/pull/57389)
* \[[`8d54c590a6`](https://github.com/nodejs/node/commit/8d54c590a6)] - **doc**: remove some inconsistencies in `deprecations.md` (Antoine du Hamel) [#57512](https://github.com/nodejs/node/pull/57512)
* \[[`c10df254ed`](https://github.com/nodejs/node/commit/c10df254ed)] - **doc**: run license-builder (github-actions\[bot]) [#57511](https://github.com/nodejs/node/pull/57511)
* \[[`61a7e44ff3`](https://github.com/nodejs/node/commit/61a7e44ff3)] - **doc**: add new writing-docs contributing md (Dario Piotrowicz) [#57502](https://github.com/nodejs/node/pull/57502)
* \[[`265510b352`](https://github.com/nodejs/node/commit/265510b352)] - **doc**: add node.js streams references to Web Streams doc (Dario Piotrowicz) [#57393](https://github.com/nodejs/node/pull/57393)
* \[[`15b841956e`](https://github.com/nodejs/node/commit/15b841956e)] - **doc**: prefer to sign commits under nodejs repository (Rafael Gonzaga) [#57311](https://github.com/nodejs/node/pull/57311)
* \[[`f46bbb281c`](https://github.com/nodejs/node/commit/f46bbb281c)] - **doc**: fixed the incorrect splitting of multiple words (letianpailove) [#57454](https://github.com/nodejs/node/pull/57454)
* \[[`c38589e45e`](https://github.com/nodejs/node/commit/c38589e45e)] - **doc**: add review guidelines for collaborator nominations (Antoine du Hamel) [#57449](https://github.com/nodejs/node/pull/57449)
* \[[`c5cafd6d9d`](https://github.com/nodejs/node/commit/c5cafd6d9d)] - **doc**: add history info for --use-system-ca (Darshan Sen) [#57432](https://github.com/nodejs/node/pull/57432)
* \[[`c526068044`](https://github.com/nodejs/node/commit/c526068044)] - **doc**: remove typo YAML snippet from tls.getCACertificates doc (Darshan Sen) [#57459](https://github.com/nodejs/node/pull/57459)
* \[[`b5554864ac`](https://github.com/nodejs/node/commit/b5554864ac)] - **doc**: fix typo in sqlite.md (Tobias Nießen) [#57473](https://github.com/nodejs/node/pull/57473)
* \[[`a11f57fa9a`](https://github.com/nodejs/node/commit/a11f57fa9a)] - **doc**: explicit mention arbitrary code execution as a vuln (Rafael Gonzaga) [#57426](https://github.com/nodejs/node/pull/57426)
* \[[`85bfba5f3a`](https://github.com/nodejs/node/commit/85bfba5f3a)] - **doc**: update maintaining-openssl.md for openssl (Richard Lau) [#57413](https://github.com/nodejs/node/pull/57413)
* \[[`d3882ed5f5`](https://github.com/nodejs/node/commit/d3882ed5f5)] - **doc**: add missing `deprecated` badges in `fs.md` (Yukihiro Hasegawa) [#57384](https://github.com/nodejs/node/pull/57384)
* \[[`7df824710a`](https://github.com/nodejs/node/commit/7df824710a)] - **doc**: add note about sync nodejs-private branches (Rafael Gonzaga) [#57404](https://github.com/nodejs/node/pull/57404)
* \[[`dc5a95ea8c`](https://github.com/nodejs/node/commit/dc5a95ea8c)] - **doc**: update Xcode version used for arm64 and pkg (Michaël Zasso) [#57104](https://github.com/nodejs/node/pull/57104)
* \[[`944311b53c`](https://github.com/nodejs/node/commit/944311b53c)] - **doc**: improve type stripping documentation (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`c75896ce5e`](https://github.com/nodejs/node/commit/c75896ce5e)] - **doc**: specificy support for erasable ts syntax (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`b0750e9fce`](https://github.com/nodejs/node/commit/b0750e9fce)] - **doc**: make first parameter optional in `util.getCallSites` (Deokjin Kim) [#57387](https://github.com/nodejs/node/pull/57387)
* \[[`0bdc8137a8`](https://github.com/nodejs/node/commit/0bdc8137a8)] - **doc**: fix usage of module.registerSync in comment (Timo Kössler) [#57328](https://github.com/nodejs/node/pull/57328)
* \[[`5e90af8e0c`](https://github.com/nodejs/node/commit/5e90af8e0c)] - **doc**: add Darshan back as voting TSC member (Michael Dawson) [#57402](https://github.com/nodejs/node/pull/57402)
* \[[`e08d3318ac`](https://github.com/nodejs/node/commit/e08d3318ac)] - **doc**: revise webcrypto.md types, interfaces, and added versions (Filip Skokan) [#57376](https://github.com/nodejs/node/pull/57376)
* \[[`bf85b6b242`](https://github.com/nodejs/node/commit/bf85b6b242)] - **doc**: add info on how project manages social media (Michael Dawson) [#57318](https://github.com/nodejs/node/pull/57318)
* \[[`8d5f57d695`](https://github.com/nodejs/node/commit/8d5f57d695)] - **doc**: revise `tsconfig.json` note (Steven) [#57353](https://github.com/nodejs/node/pull/57353)
* \[[`e20959f71a`](https://github.com/nodejs/node/commit/e20959f71a)] - **doc**: use more clear name in getSystemErrorMessage's example (ikuma-t) [#57310](https://github.com/nodejs/node/pull/57310)
* \[[`db5cc8e82d`](https://github.com/nodejs/node/commit/db5cc8e82d)] - **doc**: recommend setting `noEmit: true` in `tsconfig.json` (Steven) [#57320](https://github.com/nodejs/node/pull/57320)
* \[[`846ebd94d9`](https://github.com/nodejs/node/commit/846ebd94d9)] - **doc**: ping nodejs/tsc for each security pull request (Rafael Gonzaga) [#57309](https://github.com/nodejs/node/pull/57309)
* \[[`46c3e1e06a`](https://github.com/nodejs/node/commit/46c3e1e06a)] - **doc**: fix Windows ccache section position (Stefan Stojanovic) [#57326](https://github.com/nodejs/node/pull/57326)
* \[[`c8b795e269`](https://github.com/nodejs/node/commit/c8b795e269)] - **doc**: update node-api version matrix (Chengzhong Wu) [#57287](https://github.com/nodejs/node/pull/57287)
* \[[`3960dd85cd`](https://github.com/nodejs/node/commit/3960dd85cd)] - **doc**: recommend `erasableSyntaxOnly` in ts docs (Rob Palmer) [#57271](https://github.com/nodejs/node/pull/57271)
* \[[`6d5a9e0a89`](https://github.com/nodejs/node/commit/6d5a9e0a89)] - **doc**: clarify `path.isAbsolute` is not path traversal mitigation (Eric Fortis) [#57073](https://github.com/nodejs/node/pull/57073)
* \[[`0e54b19cd0`](https://github.com/nodejs/node/commit/0e54b19cd0)] - **doc**: fix rendering of DEP0174 description (David Sanders) [#56835](https://github.com/nodejs/node/pull/56835)
* \[[`adc727efea`](https://github.com/nodejs/node/commit/adc727efea)] - **doc**: add 1ilsang to triage team (1ilsang) [#57183](https://github.com/nodejs/node/pull/57183)
* \[[`d8a83ef2f3`](https://github.com/nodejs/node/commit/d8a83ef2f3)] - **doc**: add @geeksilva97 to collaborators (Edy Silva) [#57241](https://github.com/nodejs/node/pull/57241)
* \[[`6029c0b48c`](https://github.com/nodejs/node/commit/6029c0b48c)] - **doc**: add missing assert return types (Colin Ihrig) [#57219](https://github.com/nodejs/node/pull/57219)
* \[[`c8c7c0034c`](https://github.com/nodejs/node/commit/c8c7c0034c)] - **doc**: add streamResetBurst and streamResetRate (Sujal Raj) [#57195](https://github.com/nodejs/node/pull/57195)
* \[[`cad26c8053`](https://github.com/nodejs/node/commit/cad26c8053)] - **doc**: add esm examples to node:util (Alfredo González) [#56793](https://github.com/nodejs/node/pull/56793)
* \[[`ccbc5311c0`](https://github.com/nodejs/node/commit/ccbc5311c0)] - **doc**: update options to filehandle.appendFile() (Hasegawa-Yukihiro) [#56972](https://github.com/nodejs/node/pull/56972)
* \[[`1855817b56`](https://github.com/nodejs/node/commit/1855817b56)] - **doc**: add additional caveat for fs.watch (Michael Dawson) [#57150](https://github.com/nodejs/node/pull/57150)
* \[[`381f72cbac`](https://github.com/nodejs/node/commit/381f72cbac)] - **doc**: fix typo in Windows building instructions (Tim Jacomb) [#57158](https://github.com/nodejs/node/pull/57158)
* \[[`e13c1dfe44`](https://github.com/nodejs/node/commit/e13c1dfe44)] - **doc**: fix web.libera.chat link in pull-requests.md (Samuel Bronson) [#57076](https://github.com/nodejs/node/pull/57076)
* \[[`e187fa525f`](https://github.com/nodejs/node/commit/e187fa525f)] - **doc**: remove buffered flag from performance hooks examples (Pavel Romanov) [#52607](https://github.com/nodejs/node/pull/52607)
* \[[`1147a10b83`](https://github.com/nodejs/node/commit/1147a10b83)] - **doc**: fix 'introduced\_in' version in typescript module (1ilsang) [#57109](https://github.com/nodejs/node/pull/57109)
* \[[`851545bb9b`](https://github.com/nodejs/node/commit/851545bb9b)] - **doc**: fix link and history of `SourceMap` sections (Antoine du Hamel) [#57098](https://github.com/nodejs/node/pull/57098)
* \[[`84efcad47d`](https://github.com/nodejs/node/commit/84efcad47d)] - **doc**: add `module namespace object` links (Dario Piotrowicz) [#57093](https://github.com/nodejs/node/pull/57093)
* \[[`80cbf5e5c1`](https://github.com/nodejs/node/commit/80cbf5e5c1)] - **doc**: disambiguate pseudo-code statement (Dario Piotrowicz) [#57092](https://github.com/nodejs/node/pull/57092)
* \[[`2b2d507030`](https://github.com/nodejs/node/commit/2b2d507030)] - **doc**: update clang-cl on Windows building guide (Joyee Cheung) [#57087](https://github.com/nodejs/node/pull/57087)
* \[[`319d3f8b5b`](https://github.com/nodejs/node/commit/319d3f8b5b)] - **doc**: fix wrong articles used to address modules (Dario Piotrowicz) [#57090](https://github.com/nodejs/node/pull/57090)
* \[[`5ca6819803`](https://github.com/nodejs/node/commit/5ca6819803)] - **doc**: `modules.md`: fix `distance` definition (Alexander “weej” Jones) [#57046](https://github.com/nodejs/node/pull/57046)
* \[[`6f322c092c`](https://github.com/nodejs/node/commit/6f322c092c)] - **doc**: fix wrong verb form (Dario Piotrowicz) [#57091](https://github.com/nodejs/node/pull/57091)
* \[[`774ef8a61e`](https://github.com/nodejs/node/commit/774ef8a61e)] - **doc**: fix transpiler loader hooks documentation (Joyee Cheung) [#57037](https://github.com/nodejs/node/pull/57037)
* \[[`19d2e7005f`](https://github.com/nodejs/node/commit/19d2e7005f)] - **doc**: add a note about `require('../common')` in testing documentation (Aditi) [#56953](https://github.com/nodejs/node/pull/56953)
* \[[`ceec56f748`](https://github.com/nodejs/node/commit/ceec56f748)] - **doc**: recommend writing tests in new files and including comments (Joyee Cheung) [#57028](https://github.com/nodejs/node/pull/57028)
* \[[`73c885a502`](https://github.com/nodejs/node/commit/73c885a502)] - **doc**: improve documentation on argument validation (Aditi) [#56954](https://github.com/nodejs/node/pull/56954)
* \[[`ba60f32550`](https://github.com/nodejs/node/commit/ba60f32550)] - **doc**: buffer: fix typo on `Buffer.copyBytesFrom(` `offset` option (tpoisseau) [#57015](https://github.com/nodejs/node/pull/57015)
* \[[`21d2b174df`](https://github.com/nodejs/node/commit/21d2b174df)] - **doc**: update cleanup to trust on vuln db automation (Rafael Gonzaga) [#57004](https://github.com/nodejs/node/pull/57004)
* \[[`d3b8fed244`](https://github.com/nodejs/node/commit/d3b8fed244)] - **doc**: move stability index after history section for consistency (Antoine du Hamel) [#56997](https://github.com/nodejs/node/pull/56997)
* \[[`abec1250c5`](https://github.com/nodejs/node/commit/abec1250c5)] - **doc**: add `signal` to `filehandle.writeFile()` options (Yukihiro Hasegawa) [#56804](https://github.com/nodejs/node/pull/56804)
* \[[`21503cd17a`](https://github.com/nodejs/node/commit/21503cd17a)] - **doc**: run license-builder (github-actions\[bot]) [#56985](https://github.com/nodejs/node/pull/56985)
...
* \[[`21eafab23d`](https://github.com/nodejs/node/commit/21eafab23d)] - **fs**: apply exclude function to root path (Rich Trott) [#57420](https://github.com/nodejs/node/pull/57420)
* \[[`26863960f1`](https://github.com/nodejs/node/commit/26863960f1)] - **fs**: handle UV\_ENOTDIR in `fs.statSync` with `throwIfNoEntry` provided (Juan José Arboleda) [#56996](https://github.com/nodejs/node/pull/56996)
...
* \[[`fbc14c3bd8`](https://github.com/nodejs/node/commit/fbc14c3bd8)] - **http**: coerce content-length to number (Marco Ippolito) [#57458](https://github.com/nodejs/node/pull/57458)
...
* \[[`f0959a4657`](https://github.com/nodejs/node/commit/f0959a4657)] - **inspector**: convert event params to protocol without json (Chengzhong Wu) [#57027](https://github.com/nodejs/node/pull/57027)
* \[[`21725a57dd`](https://github.com/nodejs/node/commit/21725a57dd)] - **inspector**: skip promise hook in the inspector async hook (Joyee Cheung) [#57148](https://github.com/nodejs/node/pull/57148)
...
* \[[`2cfe31cf8a`](https://github.com/nodejs/node/commit/2cfe31cf8a)] - **lib**: add warning when binding inspector to public IP (Demian Parkhomenko) [#55736](https://github.com/nodejs/node/pull/55736)
* \[[`55f2f639bb`](https://github.com/nodejs/node/commit/55f2f639bb)] - **lib**: limit split function calls to prevent excessive array length (Gürgün Dayıoğlu) [#57501](https://github.com/nodejs/node/pull/57501)
* \[[`ce7d3a75cc`](https://github.com/nodejs/node/commit/ce7d3a75cc)] - **lib**: make getCallSites sourceMap option truly optional (James M Snell) [#57388](https://github.com/nodejs/node/pull/57388)
* \[[`f851dd51e2`](https://github.com/nodejs/node/commit/f851dd51e2)] - **lib**: optimize priority queue (Gürgün Dayıoğlu) [#57100](https://github.com/nodejs/node/pull/57100)
* \[[`857d456024`](https://github.com/nodejs/node/commit/857d456024)] - **lib**: fixup incorrect argument order in assertEncoding (James M Snell) [#57177](https://github.com/nodejs/node/pull/57177)
* \[[`8658201f82`](https://github.com/nodejs/node/commit/8658201f82)] - **meta**: add some clarification to the nomination process (James M Snell) [#57503](https://github.com/nodejs/node/pull/57503)
* \[[`c9a3bc22f8`](https://github.com/nodejs/node/commit/c9a3bc22f8)] - **meta**: remove collaborator self-nomination (Rich Trott) [#57537](https://github.com/nodejs/node/pull/57537)
* \[[`fb0c03363f`](https://github.com/nodejs/node/commit/fb0c03363f)] - **meta**: edit collaborator nomination process (Antoine du Hamel) [#57483](https://github.com/nodejs/node/pull/57483)
* \[[`ac92f0b822`](https://github.com/nodejs/node/commit/ac92f0b822)] - **meta**: move ovflowd to emeritus (Claudio W.) [#57443](https://github.com/nodejs/node/pull/57443)
* \[[`2775e70028`](https://github.com/nodejs/node/commit/2775e70028)] - **meta**: bump codecov/codecov-action from 5.3.1 to 5.4.0 (dependabot\[bot]) [#57257](https://github.com/nodejs/node/pull/57257)
* \[[`ab15f41b43`](https://github.com/nodejs/node/commit/ab15f41b43)] - **meta**: bump github/codeql-action from 3.28.8 to 3.28.10 (dependabot\[bot]) [#57254](https://github.com/nodejs/node/pull/57254)
* \[[`ae2ffa969f`](https://github.com/nodejs/node/commit/ae2ffa969f)] - **meta**: bump ossf/scorecard-action from 2.4.0 to 2.4.1 (dependabot\[bot]) [#57253](https://github.com/nodejs/node/pull/57253)
* \[[`44cd8ade59`](https://github.com/nodejs/node/commit/44cd8ade59)] - **meta**: move RaisinTen back to collaborators, triagers and SEA champion (Darshan Sen) [#57292](https://github.com/nodejs/node/pull/57292)
* \[[`2d8d68d0d5`](https://github.com/nodejs/node/commit/2d8d68d0d5)] - **meta**: bump actions/download-artifact from 4.1.8 to 4.1.9 (dependabot\[bot]) [#57260](https://github.com/nodejs/node/pull/57260)
* \[[`58e3362748`](https://github.com/nodejs/node/commit/58e3362748)] - **meta**: bump peter-evans/create-pull-request from 7.0.6 to 7.0.7 (dependabot\[bot]) [#57259](https://github.com/nodejs/node/pull/57259)
* \[[`8495d0b76c`](https://github.com/nodejs/node/commit/8495d0b76c)] - **meta**: bump step-security/harden-runner from 2.10.4 to 2.11.0 (dependabot\[bot]) [#57258](https://github.com/nodejs/node/pull/57258)
* \[[`60984b93d5`](https://github.com/nodejs/node/commit/60984b93d5)] - **meta**: bump actions/cache from 4.2.0 to 4.2.2 (dependabot\[bot]) [#57256](https://github.com/nodejs/node/pull/57256)
* \[[`fd4a9e644e`](https://github.com/nodejs/node/commit/fd4a9e644e)] - **meta**: bump actions/upload-artifact from 4.6.0 to 4.6.1 (dependabot\[bot]) [#57255](https://github.com/nodejs/node/pull/57255)
* \[[`ab5318f0e4`](https://github.com/nodejs/node/commit/ab5318f0e4)] - **meta**: bump `actions/setup-python` from 5.3.0 to 5.4.0 (dependabot\[bot]) [#56867](https://github.com/nodejs/node/pull/56867)
* \[[`1ed4f6279a`](https://github.com/nodejs/node/commit/1ed4f6279a)] - **meta**: bump `peter-evans/create-pull-request` from 7.0.5 to 7.0.6 (dependabot\[bot]) [#56866](https://github.com/nodejs/node/pull/56866)
* \[[`bb90b19d04`](https://github.com/nodejs/node/commit/bb90b19d04)] - **meta**: bump `mozilla-actions/sccache-action` from 0.0.6 to 0.0.7 (dependabot\[bot]) [#56865](https://github.com/nodejs/node/pull/56865)
* \[[`94e6d36693`](https://github.com/nodejs/node/commit/94e6d36693)] - **meta**: bump `codecov/codecov-action` from 5.0.7 to 5.3.1 (dependabot\[bot]) [#56864](https://github.com/nodejs/node/pull/56864)
* \[[`a6ebc8ea5f`](https://github.com/nodejs/node/commit/a6ebc8ea5f)] - **meta**: bump `step-security/harden-runner` from 2.10.2 to 2.10.4 (dependabot\[bot]) [#56863](https://github.com/nodejs/node/pull/56863)
* \[[`4129c961de`](https://github.com/nodejs/node/commit/4129c961de)] - **meta**: bump `actions/cache` from 4.1.2 to 4.2.0 (dependabot\[bot]) [#56862](https://github.com/nodejs/node/pull/56862)
* \[[`ec22a53901`](https://github.com/nodejs/node/commit/ec22a53901)] - **meta**: bump `actions/stale` from 9.0.0 to 9.1.0 (dependabot\[bot]) [#56860](https://github.com/nodejs/node/pull/56860)
* \[[`4309252cde`](https://github.com/nodejs/node/commit/4309252cde)] - **meta**: bump `github/codeql-action` from 3.27.5 to 3.28.8 (dependabot\[bot]) [#56859](https://github.com/nodejs/node/pull/56859)
* \[[`2cc3399d6d`](https://github.com/nodejs/node/commit/2cc3399d6d)] - **meta**: add CODEOWNERS for SQLite (Colin Ihrig) [#57147](https://github.com/nodejs/node/pull/57147)
* \[[`75339a5ba2`](https://github.com/nodejs/node/commit/75339a5ba2)] - **meta**: update last name for jkrems (Jan Martin) [#57006](https://github.com/nodejs/node/pull/57006)
...
* \[[`adaec46816`](https://github.com/nodejs/node/commit/adaec46816)] - **module**: handle cached linked async jobs in require(esm) (Joyee Cheung) [#57187](https://github.com/nodejs/node/pull/57187)
* \[[`4f0b905d3e`](https://github.com/nodejs/node/commit/4f0b905d3e)] - **module**: add dynamic file-specific ESM warnings (Mert Can Altin) [#56628](https://github.com/nodejs/node/pull/56628)
* \[[`52ba5573c8`](https://github.com/nodejs/node/commit/52ba5573c8)] - **module**: improve error message from asynchronicity in require(esm) (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`5ad8b356e8`](https://github.com/nodejs/node/commit/5ad8b356e8)] - **module**: allow omitting context in synchronous next hooks (Joyee Cheung) [#57056](https://github.com/nodejs/node/pull/57056)
* \[[`e317d948fe`](https://github.com/nodejs/node/commit/e317d948fe)] - **module**: fix require.resolve() crash on non-string paths (Aditi) [#56942](https://github.com/nodejs/node/pull/56942)
...
* \[[`6b93ba723b`](https://github.com/nodejs/node/commit/6b93ba723b)] - **(SEMVER-MINOR)** **module**: use synchronous hooks for preparsing in import(cjs) (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`b2e44a8079`](https://github.com/nodejs/node/commit/b2e44a8079)] - **(SEMVER-MINOR)** **module**: implement module.registerHooks() (Joyee Cheung) [#55698](https://github.com/nodejs/node/pull/55698)
* \[[`d768f27671`](https://github.com/nodejs/node/commit/d768f27671)] - **net**: validate non-string host for socket.connect (Daeyeon Jeong) [#57198](https://github.com/nodejs/node/pull/57198)
* \[[`0692643ce1`](https://github.com/nodejs/node/commit/0692643ce1)] - **net**: replace brand checks with identity checks (Yagiz Nizipli) [#57341](https://github.com/nodejs/node/pull/57341)
* \[[`ca18b70399`](https://github.com/nodejs/node/commit/ca18b70399)] - **net**: emit an error when custom lookup resolves to a non-string address (Edy Silva) [#57192](https://github.com/nodejs/node/pull/57192)
* \[[`dc91ae7471`](https://github.com/nodejs/node/commit/dc91ae7471)] - **(SEMVER-MINOR)** **process**: add execve (Paolo Insogna) [#56496](https://github.com/nodejs/node/pull/56496)
* \[[`e2d21e6b32`](https://github.com/nodejs/node/commit/e2d21e6b32)] - **readline**: add support for `Symbol.dispose` (Antoine du Hamel) [#57276](https://github.com/nodejs/node/pull/57276)
...
* \[[`8cfa144e82`](https://github.com/nodejs/node/commit/8cfa144e82)] - **sea**: suppress builtin warning with disableExperimentalSEAWarning option (koooge) [#57086](https://github.com/nodejs/node/pull/57086)
* \[[`5ec955a2d4`](https://github.com/nodejs/node/commit/5ec955a2d4)] - **sqlite**: add support for unknown named parameters (Colin Ihrig) [#57552](https://github.com/nodejs/node/pull/57552)
* \[[`38da6555f5`](https://github.com/nodejs/node/commit/38da6555f5)] - **sqlite**: add DatabaseSync.prototype.isOpen (Colin Ihrig) [#57522](https://github.com/nodejs/node/pull/57522)
* \[[`578b495d76`](https://github.com/nodejs/node/commit/578b495d76)] - **sqlite**: add DatabaseSync.prototype\[Symbol.dispose]\() (Colin Ihrig) [#57506](https://github.com/nodejs/node/pull/57506)
...
* \[[`7e394c82f5`](https://github.com/nodejs/node/commit/7e394c82f5)] - **src**: cleanup aliased\_buffer.h (Mohammed Keyvanzadeh) [#57395](https://github.com/nodejs/node/pull/57395)
* \[[`e986b5dc05`](https://github.com/nodejs/node/commit/e986b5dc05)] - **src**: do not pass nullptr to std::string ctor (Charles Kerr) [#57354](https://github.com/nodejs/node/pull/57354)
* \[[`a625e294e3`](https://github.com/nodejs/node/commit/a625e294e3)] - **src**: fix process exit listeners not receiving unsettled tla codes (Dario Piotrowicz) [#56872](https://github.com/nodejs/node/pull/56872)
* \[[`571475f221`](https://github.com/nodejs/node/commit/571475f221)] - **src**: refactor SubtleCrypto algorithm and length validations (Filip Skokan) [#57319](https://github.com/nodejs/node/pull/57319)
* \[[`95cb9f14e2`](https://github.com/nodejs/node/commit/95cb9f14e2)] - **src**: allow embedder customization of OOMErrorHandler (Shelley Vohr) [#57325](https://github.com/nodejs/node/pull/57325)
* \[[`8e2c2470d4`](https://github.com/nodejs/node/commit/8e2c2470d4)] - **src**: use Maybe\<void> in ProcessEmitWarningSync (Daeyeon Jeong) [#57250](https://github.com/nodejs/node/pull/57250)
* \[[`d2ae6ae185`](https://github.com/nodejs/node/commit/d2ae6ae185)] - **src**: make even more improvements to error handling (James M Snell) [#57264](https://github.com/nodejs/node/pull/57264)
* \[[`76a7af2d52`](https://github.com/nodejs/node/commit/76a7af2d52)] - **src**: use cached `emit` v8::String (Daeyeon Jeong) [#57249](https://github.com/nodejs/node/pull/57249)
* \[[`3fbd3bc8d0`](https://github.com/nodejs/node/commit/3fbd3bc8d0)] - **src**: refactor SubtleCrypto algorithm and length validations (Filip Skokan) [#57273](https://github.com/nodejs/node/pull/57273)
* \[[`f8fb7be272`](https://github.com/nodejs/node/commit/f8fb7be272)] - **src**: make more error handling improvements (James M Snell) [#57262](https://github.com/nodejs/node/pull/57262)
* \[[`32f5169bbe`](https://github.com/nodejs/node/commit/32f5169bbe)] - **src**: fix typo in comment (Antoine du Hamel) [#57291](https://github.com/nodejs/node/pull/57291)
* \[[`d44f83dc1d`](https://github.com/nodejs/node/commit/d44f83dc1d)] - **src**: improve error handling in `node_messaging.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`9b9727be4e`](https://github.com/nodejs/node/commit/9b9727be4e)] - **src**: improve error handling in `tty_wrap.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`f90ed1b653`](https://github.com/nodejs/node/commit/f90ed1b653)] - **src**: improve error handling in `tcp_wrap.cc` (James M Snell) [#57211](https://github.com/nodejs/node/pull/57211)
* \[[`21101d1a09`](https://github.com/nodejs/node/commit/21101d1a09)] - **src**: fix ThrowInvalidURL call in PathToFileURL (Daniel M Brasil) [#57141](https://github.com/nodejs/node/pull/57141)
* \[[`cd6702e17e`](https://github.com/nodejs/node/commit/cd6702e17e)] - **src**: improve error handling in buffer and dotenv (James M Snell) [#57189](https://github.com/nodejs/node/pull/57189)
* \[[`1aa2aa5e29`](https://github.com/nodejs/node/commit/1aa2aa5e29)] - **src**: improve error handling in module\_wrap (James M Snell) [#57188](https://github.com/nodejs/node/pull/57188)
* \[[`227eaf7213`](https://github.com/nodejs/node/commit/227eaf7213)] - **src**: improve error handling in spawn\_sync (James M Snell) [#57185](https://github.com/nodejs/node/pull/57185)
* \[[`b2f9c9d494`](https://github.com/nodejs/node/commit/b2f9c9d494)] - **src**: detect whether the string is one byte representation or not (theweipeng) [#56147](https://github.com/nodejs/node/pull/56147)
* \[[`838646ee6a`](https://github.com/nodejs/node/commit/838646ee6a)] - **src**: fix crash when lazy getter is invoked in a vm context (Chengzhong Wu) [#57168](https://github.com/nodejs/node/pull/57168)
* \[[`d639a7d3a6`](https://github.com/nodejs/node/commit/d639a7d3a6)] - **src**: do not format single string argument for THROW\_ERR\_\* (Joyee Cheung) [#57126](https://github.com/nodejs/node/pull/57126)
* \[[`9df35510c4`](https://github.com/nodejs/node/commit/9df35510c4)] - **src**: move instead of copy shared pointer in node\_blob (Michaël Zasso) [#57120](https://github.com/nodejs/node/pull/57120)
* \[[`79f987cd0a`](https://github.com/nodejs/node/commit/79f987cd0a)] - **src**: replace NewFromUtf8 with OneByteString where appropriate (James M Snell) [#57096](https://github.com/nodejs/node/pull/57096)
* \[[`569c956b3a`](https://github.com/nodejs/node/commit/569c956b3a)] - **src**: port `defineLazyProperties` to native code (Antoine du Hamel) [#57081](https://github.com/nodejs/node/pull/57081)
* \[[`29f385af32`](https://github.com/nodejs/node/commit/29f385af32)] - **src**: improve error handling in node\_blob (James M Snell) [#57078](https://github.com/nodejs/node/pull/57078)
* \[[`af61e98cfc`](https://github.com/nodejs/node/commit/af61e98cfc)] - **src**: fix accessing empty string (Cheng) [#57014](https://github.com/nodejs/node/pull/57014)
* \[[`60a645f6ae`](https://github.com/nodejs/node/commit/60a645f6ae)] - **src**: lock the isolate properly in IsolateData destructor (Joyee Cheung) [#57031](https://github.com/nodejs/node/pull/57031)
* \[[`df33ff0ae8`](https://github.com/nodejs/node/commit/df33ff0ae8)] - **src**: add self-assigment memcpy checks (Burkov Egor) [#56986](https://github.com/nodejs/node/pull/56986)
* \[[`57b58bc770`](https://github.com/nodejs/node/commit/57b58bc770)] - **src**: improve node::Dotenv trimming (Dario Piotrowicz) [#56983](https://github.com/nodejs/node/pull/56983)
* \[[`61bb868853`](https://github.com/nodejs/node/commit/61bb868853)] - **src**: improve error handling in string\_bytes/decoder (James M Snell) [#56978](https://github.com/nodejs/node/pull/56978)
* \[[`36b17b7424`](https://github.com/nodejs/node/commit/36b17b7424)] - **src**: improve error handling in process\_wrap (James M Snell) [#56977](https://github.com/nodejs/node/pull/56977)
* \[[`5adb42485a`](https://github.com/nodejs/node/commit/5adb42485a)] - **src**: use `args.This()` in zlib (Michaël Zasso) [#56988](https://github.com/nodejs/node/pull/56988)
* \[[`b1ca65e22f`](https://github.com/nodejs/node/commit/b1ca65e22f)] - **src**: replace `SplitString` with built-in (Yagiz Nizipli) [#54990](https://github.com/nodejs/node/pull/54990)
...
* \[[`19fde1eb94`](https://github.com/nodejs/node/commit/19fde1eb94)] - **stream**: fix sizeAlgorithm validation in WritableStream (Daeyeon Jeong) [#57280](https://github.com/nodejs/node/pull/57280)
* \[[`3847027c98`](https://github.com/nodejs/node/commit/3847027c98)] - **test**: add more number cases for buffer.indexOf (Meghan Denny) [#57200](https://github.com/nodejs/node/pull/57200)
* \[[`664b3b864a`](https://github.com/nodejs/node/commit/664b3b864a)] - **test**: update parallel/test-tls-dhe for OpenSSL 3.5 (Richard Lau) [#57477](https://github.com/nodejs/node/pull/57477)
* \[[`f9bdb3dbf0`](https://github.com/nodejs/node/commit/f9bdb3dbf0)] - **test**: module syntax should throw (Marco Ippolito) [#57121](https://github.com/nodejs/node/pull/57121)
* \[[`f338790b0c`](https://github.com/nodejs/node/commit/f338790b0c)] - **test**: update snapshots for amaro v0.3.2 (Marco Ippolito) [#56916](https://github.com/nodejs/node/pull/56916)
* \[[`7963b048ee`](https://github.com/nodejs/node/commit/7963b048ee)] - **test**: test runner run plan (Pietro Marchini) [#57304](https://github.com/nodejs/node/pull/57304)
* \[[`a8b8075ae2`](https://github.com/nodejs/node/commit/a8b8075ae2)] - **test**: update WPT for WebCryptoAPI to edd42c005c (Node.js GitHub Bot) [#57365](https://github.com/nodejs/node/pull/57365)
* \[[`70625d9ba7`](https://github.com/nodejs/node/commit/70625d9ba7)] - **test**: simplify test-tls-connect-abort-controller.js (Yagiz Nizipli) [#57338](https://github.com/nodejs/node/pull/57338)
* \[[`9d8873badf`](https://github.com/nodejs/node/commit/9d8873badf)] - **test**: use `assert.match` in `test-esm-import-meta` (Antoine du Hamel) [#57290](https://github.com/nodejs/node/pull/57290)
* \[[`41ad99b374`](https://github.com/nodejs/node/commit/41ad99b374)] - **test**: update compression wpt (Yagiz Nizipli) [#56960](https://github.com/nodejs/node/pull/56960)
* \[[`3f40f0a0ae`](https://github.com/nodejs/node/commit/3f40f0a0ae)] - _**Revert**_ "**test**: temporary remove resource check from fs read-write" (Rafael Gonzaga) [#56906](https://github.com/nodejs/node/pull/56906)
* \[[`c7f134e079`](https://github.com/nodejs/node/commit/c7f134e079)] - **test**: more common.mustNotCall in net, tls (Meghan Denny) [#57246](https://github.com/nodejs/node/pull/57246)
* \[[`fdac2fba32`](https://github.com/nodejs/node/commit/fdac2fba32)] - **test**: swap assert.strictEqual() parameters (Luigi Pinca) [#57217](https://github.com/nodejs/node/pull/57217)
* \[[`8e4037c630`](https://github.com/nodejs/node/commit/8e4037c630)] - **test**: assert write return values in buffer-bigint64 (Meghan Denny) [#57212](https://github.com/nodejs/node/pull/57212)
* \[[`24833e63c2`](https://github.com/nodejs/node/commit/24833e63c2)] - **test**: allow embedder running async context frame test (Shelley Vohr) [#57193](https://github.com/nodejs/node/pull/57193)
* \[[`3c693f1a93`](https://github.com/nodejs/node/commit/3c693f1a93)] - **test**: resolve race condition in test-net-write-fully-async-\* (Matteo Collina) [#57022](https://github.com/nodejs/node/pull/57022)
* \[[`91f6352705`](https://github.com/nodejs/node/commit/91f6352705)] - **test**: add doAppendAndCancel test (Hasegawa-Yukihiro) [#56972](https://github.com/nodejs/node/pull/56972)
* \[[`0eec572f5a`](https://github.com/nodejs/node/commit/0eec572f5a)] - **test**: fix test-without-async-context-frame.mjs in debug mode (Joyee Cheung) [#57034](https://github.com/nodejs/node/pull/57034)
* \[[`b55b9c844d`](https://github.com/nodejs/node/commit/b55b9c844d)] - **test**: make eval snapshot comparison more flexible (Shelley Vohr) [#57020](https://github.com/nodejs/node/pull/57020)
* \[[`f3dfaecc21`](https://github.com/nodejs/node/commit/f3dfaecc21)] - **test**: simplify test-http2-client-promisify-connect-error (Luigi Pinca) [#57144](https://github.com/nodejs/node/pull/57144)
* \[[`7d604ceb3e`](https://github.com/nodejs/node/commit/7d604ceb3e)] - **test**: improve error output of test-http2-client-promisify-connect-error (Antoine du Hamel) [#57135](https://github.com/nodejs/node/pull/57135)
* \[[`66775a0565`](https://github.com/nodejs/node/commit/66775a0565)] - **test**: add case for unrecognised fields within pjson "exports" (Jacob Smith) [#57026](https://github.com/nodejs/node/pull/57026)
* \[[`32fc577ee8`](https://github.com/nodejs/node/commit/32fc577ee8)] - **test**: remove unnecessary assert requiring from tests (Dario Piotrowicz) [#57008](https://github.com/nodejs/node/pull/57008)
* \[[`d764c1b4be`](https://github.com/nodejs/node/commit/d764c1b4be)] - **test**: reduce flakiness on test-net-write-fully-async-buffer (Yagiz Nizipli) [#56971](https://github.com/nodejs/node/pull/56971)
* \[[`ce9387c15f`](https://github.com/nodejs/node/commit/ce9387c15f)] - **test**: remove flakiness on macOS test (Yagiz Nizipli) [#56971](https://github.com/nodejs/node/pull/56971)
* \[[`93596bb681`](https://github.com/nodejs/node/commit/93596bb681)] - **test**: improve timeout duration for debugger events (Yagiz Nizipli) [#56970](https://github.com/nodejs/node/pull/56970)
* \[[`650bb0732a`](https://github.com/nodejs/node/commit/650bb0732a)] - **test**: remove unnecessary syscall to cpuinfo (Yagiz Nizipli) [#56968](https://github.com/nodejs/node/pull/56968)
* \[[`aeec0ae29b`](https://github.com/nodejs/node/commit/aeec0ae29b)] - **test**: update webstorage wpt (Yagiz Nizipli) [#56963](https://github.com/nodejs/node/pull/56963)
...
* \[[`52eb450e73`](https://github.com/nodejs/node/commit/52eb450e73)] - **test,crypto**: make tests work for BoringSSL (Shelley Vohr) [#57021](https://github.com/nodejs/node/pull/57021)
* \[[`4c94f31df2`](https://github.com/nodejs/node/commit/4c94f31df2)] - **test\_runner**: refactor testPlan counter increse (Pietro Marchini) [#56765](https://github.com/nodejs/node/pull/56765)
* \[[`a5fff8ae3d`](https://github.com/nodejs/node/commit/a5fff8ae3d)] - **test\_runner**: differentiate test types in enqueue dequeue events (Eddie Abbondanzio) [#54049](https://github.com/nodejs/node/pull/54049)
* \[[`5884a09e2b`](https://github.com/nodejs/node/commit/5884a09e2b)] - **test\_runner**: print formatted errors on summary (Pietro Marchini) [#56911](https://github.com/nodejs/node/pull/56911)
* \[[`5d740c8c5c`](https://github.com/nodejs/node/commit/5d740c8c5c)] - **test\_runner**: allow special characters in snapshot keys (Carlos Espa) [#57017](https://github.com/nodejs/node/pull/57017)
* \[[`f26b932ac8`](https://github.com/nodejs/node/commit/f26b932ac8)] - **timers**: optimize timer functions with improved argument handling (Gürgün Dayıoğlu) [#57072](https://github.com/nodejs/node/pull/57072)
* \[[`a18dcc1687`](https://github.com/nodejs/node/commit/a18dcc1687)] - **timers**: remove unnecessary allocation of \_onTimeout (Gürgün Dayıoğlu) [#57497](https://github.com/nodejs/node/pull/57497)
* \[[`aa4add601a`](https://github.com/nodejs/node/commit/aa4add601a)] - **timers**: remove unused parameter from insertGuarded (Gürgün Dayıoğlu) [#57251](https://github.com/nodejs/node/pull/57251)
* \[[`da0010ab15`](https://github.com/nodejs/node/commit/da0010ab15)] - **timers**: simplify the compareTimersLists function (Gürgün Dayıoğlu) [#57110](https://github.com/nodejs/node/pull/57110)
* \[[`14fcefb56a`](https://github.com/nodejs/node/commit/14fcefb56a)] - **tls**: remove unnecessary type check on normalize (Yagiz Nizipli) [#57336](https://github.com/nodejs/node/pull/57336)
* \[[`5edee197ab`](https://github.com/nodejs/node/commit/5edee197ab)] - **(SEMVER-MINOR)** **tls**: implement tls.getCACertificates() (Joyee Cheung) [#57107](https://github.com/nodejs/node/pull/57107)
* \[[`fc29d99975`](https://github.com/nodejs/node/commit/fc29d99975)] - **tools**: fix WPT update cron string (Antoine du Hamel) [#57665](https://github.com/nodejs/node/pull/57665)
* \[[`355970ae24`](https://github.com/nodejs/node/commit/355970ae24)] - **tools**: remove stalled label on unstalled issues and PRs (Rich Trott) [#57630](https://github.com/nodejs/node/pull/57630)
* \[[`1239394dea`](https://github.com/nodejs/node/commit/1239394dea)] - **tools**: update sccache to support GH cache changes (Michaël Zasso) [#57573](https://github.com/nodejs/node/pull/57573)
* \[[`bcb82c24e8`](https://github.com/nodejs/node/commit/bcb82c24e8)] - **tools**: bump @babel/helpers from 7.26.9 to 7.26.10 in /tools/eslint (dependabot\[bot]) [#57444](https://github.com/nodejs/node/pull/57444)
* \[[`24bd1b8759`](https://github.com/nodejs/node/commit/24bd1b8759)] - **tools**: add config subspace (Marco Ippolito) [#57239](https://github.com/nodejs/node/pull/57239)
* \[[`5eeb90c556`](https://github.com/nodejs/node/commit/5eeb90c556)] - **tools**: import rather than require ESLint plugins (Michaël Zasso) [#57315](https://github.com/nodejs/node/pull/57315)
* \[[`64d9d96c31`](https://github.com/nodejs/node/commit/64d9d96c31)] - **tools**: switch back to official OpenSSL (Richard Lau) [#57301](https://github.com/nodejs/node/pull/57301)
* \[[`3d8cd0fac5`](https://github.com/nodejs/node/commit/3d8cd0fac5)] - **tools**: revert to use @stylistic/eslint-plugin-js v3 (Joyee Cheung) [#57314](https://github.com/nodejs/node/pull/57314)
* \[[`8901123fbd`](https://github.com/nodejs/node/commit/8901123fbd)] - **tools**: add more details about rolling inspector\_protocol (Chengzhong Wu) [#57167](https://github.com/nodejs/node/pull/57167)
* \[[`cdde299a8a`](https://github.com/nodejs/node/commit/cdde299a8a)] - **tools**: bump the eslint group in /tools/eslint with 5 updates (dependabot\[bot]) [#57261](https://github.com/nodejs/node/pull/57261)
* \[[`6698e4ee18`](https://github.com/nodejs/node/commit/6698e4ee18)] - **tools**: remove deps/zlib/GN-scraper.py (Chengzhong Wu) [#57238](https://github.com/nodejs/node/pull/57238)
* \[[`706f8af42d`](https://github.com/nodejs/node/commit/706f8af42d)] - **tools**: run Linux tests on GitHub arm64 runners as well (Dennis Ameling) [#57162](https://github.com/nodejs/node/pull/57162)
* \[[`840da26ae7`](https://github.com/nodejs/node/commit/840da26ae7)] - **tools**: consolidate 'introduced\_in' check for docs (1ilsang) [#57109](https://github.com/nodejs/node/pull/57109)
* \[[`6a001c9745`](https://github.com/nodejs/node/commit/6a001c9745)] - **tools**: do not run major-release workflow on forks (Rich Trott) [#57064](https://github.com/nodejs/node/pull/57064)
* \[[`0abe616a35`](https://github.com/nodejs/node/commit/0abe616a35)] - **tools**: fix release URL computation in update-root-certs.mjs (Joyee Cheung) [#56843](https://github.com/nodejs/node/pull/56843)
* \[[`f2ac0b06fa`](https://github.com/nodejs/node/commit/f2ac0b06fa)] - **tools**: add support for `import source` syntax in linter (Antoine du Hamel) [#56992](https://github.com/nodejs/node/pull/56992)
* \[[`cf09dc9e2b`](https://github.com/nodejs/node/commit/cf09dc9e2b)] - **tools**: bump eslint version (dependabot\[bot]) [#56869](https://github.com/nodejs/node/pull/56869)
...
* \[[`857b66d4be`](https://github.com/nodejs/node/commit/857b66d4be)] - **typings**: fix `ImportModuleDynamicallyCallback` return type (Chengzhong Wu) [#57160](https://github.com/nodejs/node/pull/57160)
* \[[`900596074b`](https://github.com/nodejs/node/commit/900596074b)] - **util**: avoid run debug when enabled is false (fengmk2) [#57494](https://github.com/nodejs/node/pull/57494)
* \[[`f9fe0e09ee`](https://github.com/nodejs/node/commit/f9fe0e09ee)] - **(SEMVER-MINOR)** **util**: expose diff function used by the assertion errors (Giovanni Bucci) [#57462](https://github.com/nodejs/node/pull/57462)
...
* \[[`673a424180`](https://github.com/nodejs/node/commit/673a424180)] - **(SEMVER-MINOR)** **v8**: add v8.getCppHeapStatistics() method (Aditi) [#57146](https://github.com/nodejs/node/pull/57146)
* \[[`36ebfd4232`](https://github.com/nodejs/node/commit/36ebfd4232)] - **win,build**: add option to enable Control Flow Guard (Hüseyin Açacak) [#56605](https://github.com/nodejs/node/pull/56605)
* \[[`b63da172fc`](https://github.com/nodejs/node/commit/b63da172fc)] - **win,test**: disable test case failing with ClangCL (Stefan Stojanovic) [#57397](https://github.com/nodejs/node/pull/57397)
* \[[`59bebd4d7f`](https://github.com/nodejs/node/commit/59bebd4d7f)] - **zlib**: use modern class syntax for zstd classes (Yagiz Nizipli) [#56965](https://github.com/nodejs/node/pull/56965)
* \[[`f6c7e1cbf4`](https://github.com/nodejs/node/commit/f6c7e1cbf4)] - **zlib**: make all zstd functions experimental (Yagiz Nizipli) [#56964](https://github.com/nodejs/node/pull/56964)
* \[[`4991e5d826`](https://github.com/nodejs/node/commit/4991e5d826)] - **(SEMVER-MINOR)** **zlib**: add zstd support (Jan Martin) [#52100](https://github.com/nodejs/node/pull/52100)
